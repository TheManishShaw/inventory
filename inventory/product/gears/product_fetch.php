<?php
    ...
    `_brands`.`name` AS `brand_name`,`stock_tbl`.`stock`,`_tblproducts`.`image`,`_tblproducts`.`status` FROM 
    ...
    `_tblproducts`.`chain_id`='$chain_id') AND `_tblproducts`.`status`='active' ORDER BY `_tblproducts`.`id` DESC";
