...
<head>
    <title>Customer List – <?php echo $sys_title ?></title>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <div class="pt-10">
                            <h1 class="anchor fw-bolder mb-5">Customer List</h1>
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" id="btn-div" data-kt-docs-table-toolbar="base">
                                    ...
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_customer.php" data-name="Add Customers"
                                        class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Customers</a>
                                    <!-- end:: Add Customer -->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <div class="my-5">
                                <table id="customer-tbl" class="table table-striped gy-5 gs-7 border rounded">
                                    <thead>
    ...
    <script>
        ...
        function checkboxEvent(){
            ...
            function checkboxDeleteButton(){
                ...
                if (checking == true) {
                    ...
                    document.querySelector("#btn-div").innerHTML = `<!-- begin:: Add Customer -->
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_customer.php" data-name="Add Customer"
                                        class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Customer</a>
                                    <!-- end:: Add Customer -->`;
                }
            } 
            ...
            $('#customer-tbl').on( 'draw.dt',   function () { 
                            ...
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        data-href="modal/update_customer.php?id=`+row.u_id+`" data-name="Update Customer">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
        ...
        function handleSearchDatatable() {
            ...
            filterSearch.addEventListener('keyup', function (e) {
                $('#customer-tbl').DataTable().search(e.target.value).draw();
            });
        }
