...
<head>
    <title>Supplier List – <?php echo $sys_title ?></title>
...
<body id="kt_body" class="aside-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <div class="pt-10">
                            <h1 class="anchor fw-bolder mb-5">Supplier List</h1>
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" id="btn-div" data-kt-docs-table-toolbar="base">
                                    ...
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_supplier.php" data-name="Add Suppliers"
                                        class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Suppliers</a>
                                    <!-- end:: Add Supplier -->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <div class="my-5">
                                <table id="supplier-tbl" class="table table-striped gy-5 gs-7 border rounded">
                                    <thead>
    ...
    <script>
        ...
        function checkboxEvent(){
            ...
            function checkboxDeleteButton(){
                ...
                if (checking == true) {
                    ...
                    document.querySelector("#btn-div").innerHTML = `<!-- begin:: Add Supplier -->
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_supplier.php" data-name="Add Supplier"
            ...
            $('#supplier-tbl').on( 'draw.dt',   function () { 
        ...
        $(function(){
            var table = $("#supplier-tbl").DataTable({
                "ajax": "gears/supplier_fetch.php",
                "deferRender": true,
                "columns": [
                    {"data": "u_id",
                            ...
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        data-href="modal/update_supplier.php?id=`+row.u_id+`" data-name="Update Supplier">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:void(0);" class="menu-link px-3 delete-action" delete-id="`+row.u_id+`" 
                                        data-kt-supplier-table-filter="delete_row">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
        ...
        function handleSearchDatatable() {
            ...
            filterSearch.addEventListener('keyup', function (e) {
                $('#supplier-tbl').DataTable().search(e.target.value).draw();
            });
        }

        function reloadDatatable() {
            $('#supplier-tbl').DataTable().ajax.reload();
            setTimeout(function(){
                checkboxEvent();
                handleSearchDatatable();
                KTMenu.createInstances();
