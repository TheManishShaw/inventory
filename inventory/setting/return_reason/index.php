...
<head>
    <title>Return Reason List – <?php echo $sys_title ?></title>
...
<body id="kt_body" class="aside-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <div class="">
                            <h1 class="anchor fw-bolder mb-5">Return Reason List</h1>
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" id="btn-div" data-kt-docs-table-toolbar="base">
                                    <!-- begin:: Add Return Reason -->
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_return_reason.php" data-name="Add Return Reason"
                                        class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Return Reason</a>
                                    <!-- end:: Add Return Reason -->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <div class="my-5">
                                <table id="return_reason-tbl" class="table table-striped gy-5 gs-7 border rounded">
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">Return Type</th>
                                            <th class="min-w-125px">Return Reason</th>
                                            <th class="min-w-125px">Return Percent</th>
    ...
    <script>
        ...
        function checkboxEvent(){
            ...
            function checkboxDeleteButton(){
                ...
                if (checking == true) {
                    ...
                    document.querySelector("#btn-div").innerHTML = `<a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_return_reason.php" data-name="Add Return Reason"
                                        class="openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add return_reason</a>`;
                }
            } 
            ...
            $('#return_reason-tbl').on( 'draw.dt',   function () { 
                ...
                if(document.querySelector("#delete-unit")){
                    document.querySelector("#btn-div").innerHTML = `<!-- begin:: Add Return Reason -->
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                    data-href="modal/create_return_reason.php" data-name="Add Return Reason"
                                    class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Return Reason</a>
                                    <!-- end:: Add Return Reason -->`;
        ...
        $(function(){
            var table = $("#return_reason-tbl").DataTable({
                "ajax": "gears/return_reason_fetch.php",
                "deferRender": true,
                "columns": [
                    {"data": "id",
                            ...
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        data-href="modal/update_return_reason.php?id=`+row.id+`" data-name="Update Return Reason">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
        ...
        function handleSearchDatatable() {
            ...
            filterSearch.addEventListener('keyup', function (e) {
                $('#return_reason-tbl').DataTable().search(e.target.value).draw();
            });
        }

        function reloadDatatable() {
            $('#return_reason-tbl').DataTable().ajax.reload();
            setTimeout(function(){
                checkboxEvent();
                handleSearchDatatable();
                KTMenu.createInstances();
