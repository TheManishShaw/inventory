...
<div class="mb-10">
    ...
    <input type="text" class="form-control form-control-solid" name="u_name" value="<?php echo $row['name'];?>"
     id="u_name" placeholder="Enter Unit Name"/>
</div>
<div class="mb-10">
    <label for="u_shortname" class="required form-label">Short Name</label>
    <input type="text" class="form-control form-control-solid" name="u_shortname" value="<?php echo $row['ShortName'];?>"
