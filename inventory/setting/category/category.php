            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <div class="pt-10">
                            <h1 class="anchor fw-bolder mb-5">Category List</h1>
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" id="btn-div" data-kt-docs-table-toolbar="base">
                                    ...
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_category.php" data-name="Add Categories"
                                        class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Categories</a>
                                    <!-- end:: Add Category -->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <div class="my-5">
                                <table id="category-tbl" class="table table-striped gy-5 gs-7 border rounded">
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">Category Brand</th>
    ...
    <script>
        ...
        function checkboxEvent(){
            ...
            function checkboxDeleteButton(){
                ...
                if (checking == true) {
                    ...
                    document.querySelector("#btn-div").innerHTML = `<!-- begin:: Add Category -->
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                        data-href="modal/create_category.php" data-name="Add Category"
            ...
            $('#category-tbl').on( 'draw.dt',   function () { 
                        ...
                        "render": function(data,type,row) {
                            return `<div
                                        ...
                                        <input class="form-check-input" type="checkbox" data-kt-check="true"
                                            ...
                                            value="1" id="checkbox`+row.cat_id+`" />
                                    </div>`;
                        }
                    },
                    {"data":"cat_id"},
                            ...
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        data-href="modal/update_category.php?id=`+row.cat_id+`" data-name="Update Category">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:void(0);" class="menu-link px-3 delete-action" delete-id="`+row.cat_id+`" 
        ...
        function handleSearchDatatable() {
            ...
            filterSearch.addEventListener('keyup', function (e) {
                $('#category-tbl').DataTable().search(e.target.value).draw();
            });
        }
