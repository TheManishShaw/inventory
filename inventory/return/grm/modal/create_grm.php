...
<head>
    <title>Create GRM – <?php echo $sys_title ?></title>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <div class=" card-flush  flex-row-fluid ">
                            ...
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <form data-toggle="validator" action="../gears/create_grm.php" method="POST" id="uploadForm"
                                autocomplete="off" enctype="multipart/form-data">
                                <div class="row my-4">
                                    <div class="col-6">   
                                        <label class="fw-bolder" for="date">Date</label>
                                        <input type="text" id="date" placeholder="Enter Date" 
                                        class="form-control" name="date" value="<?php echo date("d-m-Y H:i:s");?>" />
                                    </div>
                                    <div class="col-6">
