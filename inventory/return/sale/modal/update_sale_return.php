<?php
    ...
    $query = "SELECT * FROM `_tblsales_return` WHERE `sale_id`='$sale_id'";
...
<head>
    <title>Update Sale Return – <?php echo $sys_title ?></title>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <!--begin::Update Sale Return-->
                        <div class=" card-flush  flex-row-fluid p-6 ">
                            <!--begin::Card header-->
                            <div class="card-header mb-2">
                                <div class="card-title">
                                    <h2>Update Sale Return</h2>
                                </div>
                            </div>
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <form data-toggle="validator" action="../gears/update_sale_return.php" method="POST" id="uploadForm"
                                ...
                                <div class="row my-4">
                                    <div class="col-6">   
                                        ...
                                        value="<?php echo date('d-m-Y H:i:s',strtotime($saleRow['date']));?>" name="date">
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <div style="height: auto; float: right; padding: 10px;">
                                            ...
                                            <div class="px-2 input-group" style="background-color: #f5f5f5;">
                                                ...
                                                readonly id="grandtotal_disp" value="<?php echo $saleRow['total_amount']?>"/>
                                ...
                                <div role="group" class="input-group">
                                    ...
                                    <?php if($saleRow['discount_method']=='fixed') echo 'fa-rupee-sign';
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control" data-regex="[^0-9.]"
                                 name="amount" id='amount-input' value="<?php echo $saleRow['paid_amount'];?>">
                                </div>
                            </div>
                            <div class="col-md-3">
