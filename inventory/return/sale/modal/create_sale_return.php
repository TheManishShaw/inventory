...
<head>
    <title>Create Sale Return – <?php echo $sys_title ?></title>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <div class=" card-flush  flex-row-fluid ">
                            ...
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <form data-toggle="validator" action="../gears/create_sale_return.php" method="POST" id="uploadForm"
