<?php
    ...
    $sale = 'RS_'.rand(101287,999012);

    $salesDate = htmlspecialchars($_POST['date']);
    ...
    $salesDate = mysqli_real_escape_string($link,$salesDate);
    ...
    $query = "INSERT INTO `_tblsales_return` (`user_id`,`date`,`sale_id`,`client_id`,`uset`,`net_tax`,
    `discount`,`discount_method`,`total_amount`,`paid_amount`,`payment_method`,`payment_status`,`split_amount`,
    `split_payment_method`,`notes`,`created_at`,`status`) VALUES ('$u_id','$salesDate','$sale',
    '$customer','$u_set','$total_tax','$discount','$discount_type','$grandTotal','$amount','$payment_method',
