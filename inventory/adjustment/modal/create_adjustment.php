...
<head>
    <title>Create Adjustment – <?php echo $sys_title ?></title>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <div class=" card-flush  flex-row-fluid p-6 ">
                            ...
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <form data-toggle="validator" action="../gears/create_adjustment.php" method="POST" id="uploadForm" autocomplete="off" enctype="multipart/form-data">
                                <div class="row my-4">
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea type="textarea" class="form-control" rows="3" id="notes" name="notes"></textarea>
                                    </div>
                                </div>
