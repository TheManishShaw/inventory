...
<head>
    <title>Adjustment List – <?php echo $sys_title;?></title>
...
<body id="kt_body" class="aside-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <div class="pt-10">
                            <h1 class="anchor fw-bolder mb-5">Adjustment List</h1>
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" id="btn-div" data-kt-docs-table-toolbar="base">
                                    ...
                                    <a href="modal/create_adjustment.php" class="btn btn-primary float-end">
                            ...
                            <!--begin::Datatable-->
                            <table id="adjustment-tbl" class="table align-middle table-row-dashed fs-6 gy-5">
                                <thead>
    ...
    <script>
        ...
        function checkboxEvent(){
            ...
            function checkboxDeleteButton(){
                ...
                if (checking == true) {
                    ...
                    document.querySelector("#btn-div").innerHTML = `<!-- begin:: Add Adjustment -->
                                    <a href="modal/create_adjustment.php" class="btn btn-primary float-end">
                                    <i class="fa fa-plus"></i> Add Adjustment</a>
                                    <!-- end:: Add Adjustment -->`;
                }
            ...
            $('#adjustment-tbl').on( 'draw.dt',   function () { 
        ...
        $(function(){
            var table = $("#adjustment-tbl").DataTable({
                "ajax": "gears/adjustment_fetch.php",
                "deferRender": true,
                "columns": [
                    {"data": "id",
                        "render": function(data,type,row) {
                            return `<div
                                        ...
                                        <input class="form-check-input" type="checkbox" data-kt-check="true"
                                            ...
                                            value="1" id="checkbox`+row.adj_id+`" />
                                    </div>`;
                        }
                    },
                    {"data":"adj_id"},
                            ...
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="table-modal menu-link px-3" href="modal/update_adjustment.php?id=`+row.adj_id+`"
                                        >Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:void(0);" class="menu-link px-3 delete-action" delete-id="`+row.adj_id+`" 
        ...
        function handleSearchDatatable() {
            ...
            filterSearch.addEventListener('keyup', function (e) {
                $('#adjustment-tbl').DataTable().search(e.target.value).draw();
            });
        }

        function reloadDatatable() {
            $('#adjustment-tbl').DataTable().ajax.reload();
            setTimeout(function(){
                checkboxEvent();
                handleSearchDatatable();
                KTMenu.createInstances();
