...
<head>
    <title>Chain List – <?php echo $sys_title ?></title>
...
<body id="kt_body" class="aside-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        <div class="">
                            <h1 class="anchor fw-bolder mb-5">Chain List</h1>
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" id="btn-div" data-kt-docs-table-toolbar="base">
                                    ...
                                    data-href="modal/create_chain.php" data-name="Add Chain"
                            ...
                            <!--begin::Datatable-->
                            <table id="chain-tbl" class="table align-middle table-row-dashed fs-6 gy-5">
                                <thead>
    ...
    <script>
        ...
        function checkboxEvent(){
            ...
            function checkboxDeleteButton(){
                ...
                if (checking == true) {
                    ...
                    document.querySelector("#btn-div").innerHTML = `<!-- begin:: Add Chain -->
                                    <a href="javascript:void(0);" onclick="modal_show()"
                                    data-href="modal/create_chain.php" data-name="Add Chain"
                                    class=" openPopup btn btn-primary float-end"><i class="fa fa-plus"></i> Add Chain</a>
                                    <!-- end:: Add Chain -->`;
        ...
        $(function(){
            var table = $("#chain-tbl").DataTable({
                "ajax": "gears/chain_fetch.php",
                "deferRender": true,
                "columns": [
                    {"data": "chain_id",
                        "render": function(data,type,row) {
                            return `<div
                                        ...
                                        <input class="form-check-input" type="checkbox" data-kt-check="true"
                                            ...
                                            value="1" id="checkbox`+row.chain_id+`" />
                                    </div>`;
                        }
                    },
                    {"data":"chain_id"},
                    {"data": "chain_logo",
                        "render": function(data,type,row) {
                            return `<div>
                                        <img src="../../data/chain_img/`+data+`" alt="`+row.chain_name+`"
                            ...
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        data-href="modal/update_chain.php?id=`+row.chain_id+`" data-name="Update Chain">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:void(0);" class="menu-link px-3 delete-action" delete-id="`+row.chain_id+`" 
        ...
        function handleSearchDatatable() {
            ...
            filterSearch.addEventListener('keyup', function (e) {
                $('#chain-tbl').DataTable().search(e.target.value).draw();
            });
        }

        function reloadDatatable() {
            $('#chain-tbl').DataTable().ajax.reload();
            setTimeout(function(){
                checkboxEvent();
                handleSearchDatatable();
                KTMenu.createInstances();
