...
$query = "SELECT 
            `date`,`sale_id`,`client_id`,`uset`,`net_tax`,`discount`,`discount_method`,`_tblsales`.`total_amount`,
            `paid_amount`,`payment_method`,`payment_status`,`split_amount`,`split_payment_method`,`notes`,
            `invoice_data`,`credit_tbl`.`transaction_type`
          FROM  `_tblsales`
          INNER JOIN
            `credit_tbl`
          ON `credit_tbl`.`transaction_id` = `sale_id`
...
<head>
    <title>Update Credit – <?php echo $sys_title ?></title>
...
<body id="kt_body" class="aside-enabled">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <div class=" card-flush  flex-row-fluid">
                            ...
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <form data-toggle="validator" action="../gears/update_credit.php" method="POST" id="uploadForm" autocomplete="off" enctype="multipart/form-data">
                                <div class="row my-4">
                                    <div class="col-6">
                                        <input type="text" name="transaction_id" value="<?php echo $sale_id; ?>" hidden />
                                        <label class="fw-bolder" for="date">Date</label>
                                        <input type="text" id="date" value="<?php echo date('d-m-Y H:i:s', strtotime($saleRow['date'])); ?>" placeholder="Enter Date" class="form-control" name="date" readonly>
                                    </div>
                                    <div class="col-6">
                                        <label class="fw-bolder" for="supply">Customer</label>
                                        <select class="form-control" data-control="select2" id="customer" data-placeholder="Choose customer..." name="customer" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="flex-grow-1">
                                                <select id="products" class="form-select rounded-start-0" data-control="select2" data-placeholder="Choose products by code or name.">
                                                    <option></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <tbody style="max-height:250px;overflow:auto;">
                                            ...
                                            ?>
                                                <tr class="text-center product-row" id="product<?php echo $productsRow['product_id']; ?>">
                                                    <td class="px-3">
                                                        <p><?php echo $productsRow['name']; ?></p><span class="badge badge-success"><?php echo $productsRow['code']; ?></span>
                                                    ...
                                                    <td>
                                                        <div class="position-relative w-md-100px" data-kt-dialer="true" data-kt-dialer-min="1" data-kt-dialer-max="50000" data-kt-dialer-step="1" data-kt-dialer-prefix="" data-kt-dialer-decimals="0">
                                                            ...
                                                            <!--begin::Input control-->
                                                            <input type="text" class="form-control form-control-solid product-quantity border-0 ps-12" placeholder="Amount" name="quantity[]" value="<?php echo $productsRow['quantity']; ?>" />
                                                    ...
                                                    <td><span class="product-tax"><?php echo $productsRow['net_tax']; ?></span>
                                                        <input class="product-tax-input" name="tax[]" value="<?php echo $productsRow['net_tax']; ?>" hidden />
                                                        <input class="product-tax-single" value="<?php echo $productsRow['net_tax'] / $productsRow['quantity']; ?>" hidden />
                                                    </td>
                                                    <td><span class="product-subtotal">
                                                        ...
                                                        <input class="product-subtotal-single" value="<?php echo $productsRow['total_amount'] / $productsRow['quantity']; ?>" hidden />
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="col-12">
                                        <div style="height: auto; float: right; padding: 10px;">
                                            <div class="px-2" style="background-color: #f5f5f5;">
                                                <div class="input-group">
                                                    <label class="mt-1 pl-1" for="order_tax_disp" style="width: 100px;">GST :</label>
                                                    <input class="text-end" id="tax_disp" readonly value="<?php echo $saleRow['net_tax']; ?>" style="width: 150px; background-color: #f5f5f5; border: none" />
                                                    <input type="number" name="total_tax" id="total_tax" value="<?php echo $saleRow['net_tax']; ?>" readonly hidden />
                                            ...
                                            <div class="px-2 input-group">
                                                ...
                                                ?>
                                                <input class="text-end" id="discount_disp" style="width: 150px; border: none;" value="<?php echo $discount; ?>" readonly disabled />
                                                <input type="number" class="text-end" name="total_discount" id="total_discount" value="<?php echo $discount; ?>" readonly hidden />
                                                <i class="fas fa-rupee-sign mt-2"></i>
                                            </div>
                                            <div class="px-2 input-group" style="background-color: #f5f5f5;">
                                                <label class="mt-1 pl-1" for="grand_total" style="width: 100px;"><b>Grand
                                                        Total :</b></label>
                                                <input class="text-end" style="width: 150px; background-color: #f5f5f5; border: none" value="<?php echo $saleRow['total_amount']; ?>" readonly id="grandtotal_disp" />
                                                <input type="number" name="grand_total" id="grand_total" value="<?php echo $saleRow['total_amount']; ?>" readonly hidden />
                                                <i class="fas fa-rupee-sign mt-2"></i>
                                            </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control" id="discount-select" name="discount_type">
                                                <option class="form-control" value="fixed" <?php if ($saleRow['discount_method'] == 'fixed') echo 'selected'; ?>>Fixed</option>
                                                <option class="form-control" value="percent" <?php if ($saleRow['discount_method'] == 'percent') echo 'selected'; ?>>Percent</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        ...
                                        <div role="group" class="input-group">
                                            <input type="text" class="form-control" id="discount" name="discount" value="<?php echo $saleRow['discount']; ?>" required>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <select class="form-control mb-3" name="payment_status">
                                            <option value="credit" <?php if ($saleRow['transaction_type'] === 'credit') echo 'selected'; ?>>Credit</option>
                                            <option value="advance" <?php if ($saleRow['transaction_type'] === 'advance') echo 'selected'; ?>>Advance</option>
                                        </select>
                                    </div>

                                </div>
                                <!?php if ($saleRow['payment_status'] === 'Advance' || $saleRow['payment_status'] === 'Credit') { ?>
                                <!-- Keeping this code here just in case -->
                                <div class="row">
                                <!--<div>
                                        <label>Transaction Type: </label>
                                        <button type="button" class="badge badge-primary">
                                            <!?php echo $saleRow['payment_status']; ?>
                                        </button>
                                    </div>
                                    <div>
                                        <label>Change to: </label>
                                        <button type="button" class="badge badge-danger" id="toggle-transaction"
                                        data-id="<!?php echo $sale_id; ?>"
                                        data-type="<!?php echo $saleRow['payment_status']; ?>">
                                            <!?php 
                                                if ($saleRow['payment_status'] == 'Credit')
                                                    echo 'Advance'; 
                                                else if ($saleRow['payment_status'] == 'Advance')
                                                    echo 'Credit';
                                            ?>
                                        </button>
                                    </div> -->
                                    <?php if ($saleRow['payment_method']) {?>
                                        <div>
                                            <button type="button" class="btn btn-secondary" id="cancel-pay">Cancel Payment</button>
                                        </div>
                                    <?php } else {?>
                                    <div>
                                        <button type="button" class="btn btn-secondary" id="pay-now">Pay Now</button>
                                    </div>
                                    <?php } ?>
                                </div>
                                
                                <?php
                                if ($saleRow['payment_method']) { ?>
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <label for="validationCustom02">Amount</label>
                                        <div role="group" class="input-group">
                                            <input type="text" class="form-control" data-regex="[^0-9.]" value="<?php echo $saleRow['paid_amount']; ?>" name="amount" id='amount-input'>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group" id="payment-choice">
                                            <div class="ml-2 btn-group" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                                ...
                                                <label class="btn btn-outline-success <?php echo $active ?>" data-kt-button="true">
                                                    <input class="btn-check" type="radio" name="payment_method" id="cash" value="cash" autocomplete="off" checked="<?php echo $checked; ?>"> Cash
                                                </label>
                                                <?php
                                                $active = '';
                                                $checked = '';
                                                ...
                                                <label class="btn btn-outline-primary <?php echo $active; ?>" data-kt-button="true">
                                                    <input class="btn-check" type="radio" name="payment_method" id="card" value="card" <?php echo $checked; ?> autocomplete="off"> Card
                                                </label>
                                                <?php
                                                $active = '';
                                                $checked = '';
                                                ...
                                                <label class="btn btn-outline-info <?php echo $active; ?>" data-kt-button="true">
                                                    <input class="btn-check" type="radio" name="payment_method" id="upi" value="upi" <?php echo $checked; ?> autocomplete="off"> UPI
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="split-amount-div" class="row">
                                    ...
                                    ?>
                                        <div class="col-md-4 mb-2">
                                            <label for="validationCustom02">Amount</label>
                                            <div role="group">
                                                <input type="text" class="form-control" value="<?php echo $saleRow['split_amount']; ?>" disabled id="split-input">
                                                <input type="text" value="<?php echo $saleRow['split_amount']; ?>" class="form-control" name="split_amount" hidden id="split-input-hidden">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Payment Choice</label>
                                            <div class="form-group">
                                                <div class="ml-2 btn-group" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                                    ...
                                                    ?>
                                                    <label class="btn btn-outline-success <?php echo $active; ?>" data-kt-button="true">
                                                        <input class="btn-check" type="radio" name="split_payment_method" value="cash" <?php echo $checked; ?> autocomplete="off"> Cash
                                                    </label>
                                                    <?php
                                                    $active = '';
                                                    $checked = '';
                                                    ...
                                                    ?>
                                                    <label class="btn btn-outline-primary <?php echo $active; ?>" data-kt-button="true">
                                                        <input class="btn-check" type="radio" name="split_payment_method" value="card" <?php echo $checked; ?> autocomplete="off"> Card
                                                    </label>
                                                    <?php
                                                    $active = '';
                                                    $checked = '';
                                                    ...
                                                    ?>
                                                    <label class="btn btn-outline-info <?php echo $active; ?>" data-kt-button="true">
                                                        <input class="btn-check" type="radio" name="split_payment_method" value="upi" <?php echo $checked; ?> autocomplete="off" checked> UPI
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea type="textarea" class="form-control" rows="5" id="notes" name="notes"><?php echo $saleRow['notes']; ?></textarea>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('body').on('input','#amount-input', function(e) {
            this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');
            let grandTotal = Number($("#grand_total").val());
        ...
        // code for showing split amount menu, in case pay now button is clicked
        $('body').on('click','#pay-now',function(){
            let amount = document.querySelector('#grand_total').value
            $('#pay-now').closest('.row').after(`
                <div class="row">
                    <div class="col-md-4 mb-2">
                        <label for="validationCustom02">Amount</label>
                        <div role="group" class="input-group">
                            <input type="text" class="form-control" data-regex="[^0-9.]" value="${amount}" name="amount" id='amount-input'>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label>Payment Choice</label>
                        <div class="form-group" id="payment-choice">
                            <div class="ml-2 btn-group" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                <label class="btn btn-outline-success active" data-kt-button="true">
                                    <input class="btn-check" type="radio" name="payment_method" id="cash" value="cash" autocomplete="off" checked> Cash
                                </label>
                                <label class="btn btn-outline-primary" data-kt-button="true">
        ...
        // Onclick handler for cancel payment button
        $('body').on('click','#cancel-pay',function(){
