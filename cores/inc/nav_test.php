							...
							<div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
								...
								<div class="me-5">
									...
									<div class="symbol symbol-40px cursor-pointer" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-overflow="true">
										<img src="<?php echo $sys_link ?>/assets/media/avatars/150-26.jpg" alt="" />
									</div>
									<!--end::Symbol-->
									<!--begin::Menu-->
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													<div class="fw-bolder d-flex align-items-center fs-5">Manish Shaw
													<span class="badge badge-light-primary fw-bolder fs-8 px-2 py-1 ms-2">Group</span></div>
													<a href="#" class="fw-bold text-muted text-hover-primary fs-7">demo@example.com</a>
												</div>
												<!--end::Username-->
											</div>
										</div>
